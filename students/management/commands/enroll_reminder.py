# students.management.commands.enroll_remider.py
...
class Command(BaseCommand):
    help = 'sends an e-mail remider to users registered more \
        than N days that are not enrolled into any course yet'
    ...
    def handle(self, *args, **options):
        ...
        for user in users:
            message = """Dear {},
            We noticed you didnt enroll in any course yet.add()
